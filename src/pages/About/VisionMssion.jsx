        ...
        <div className="container">
          <div className="row align-items-center rtl-header">
            <div className="col-12 col-lg-6 col-xl-6">
              ...
              >
                <div className="section__content text-start">
                  ...
                  {/* <p className="mt-16">
                    Your gaming doesn't stop at just playing—you can earn big by
                    referring friends too! Our Refer & Earn program is designed
                    to reward you.
                  </p> */}
                </div>
            ...
            {/* <div className="col-12 col-lg-6 col-xl-5 offset-xl-1">
              <div className="refer__thumb d-lg-block">
                <div
                  className="thumb"
                  data-aos="zoom-in"
                  data-aos-duration="600"
